...
public class ControlStatement {
	...
	public static void main(String[] args) {
		...
		// Here user used the if statement
		int number = 21;
		...
		System.out.println("#####################################");
		// Here user used the if else statement
		...
		// Here user used the if else if statement
		...
		// Here user used the Nested if statement
		...
		// Here user used the switch statement
